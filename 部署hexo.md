...
* 新版Next配合hexo配置,本次配置Next采用8.x版本,hexo采用6.x版本,因旧版本配置方式需要clone一份theme到本地,不方便升级,所以后续的hexo主题采用`_config.[theme_name].yml`的方式配置
...
# 版权提示, 原版是需要配置post_copyright的.新版本不需要
...
social:
  GitHub: https://github.com/jev001 || fab fa-github
...
footer:
  ...
  copyright: jev001. All rights reserved.
...
# 展示follow me on github的链接图标
# `Follow me on GitHub` banner in the top-right corner.
github_banner:
  enable: true
  permalink: https://github.com/jev001
